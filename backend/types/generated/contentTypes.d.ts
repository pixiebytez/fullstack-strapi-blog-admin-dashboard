...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog posts with full CMS capabilities';
    displayName: 'Blog';
    pluralName: 'blogs';
    singularName: 'blog';
  };
  ...
  attributes: {
    aiGenerated: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    trendingScore: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog post comments with moderation';
    displayName: 'Comment';
    pluralName: 'comments';
